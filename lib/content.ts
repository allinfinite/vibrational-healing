export const LINEAGE_CONTENT = [
  ...
  },
  {
    ...
    title: 'Integral Resonance Theory',
    text: 'The idea that personal coherence radiates outward into collective fields.',
    relatedMethod: 'meditating-figure',
    fullDescription: 'Integral Resonance suggests that we are not isolated islands. When an individual achieves a state of "Personal Coherence" (heart-brain synchronization), they act as a tuning fork for their environment. Their stable vibration helps to stabilize others, creating a field effect of peace.'
  },
  {
    id: 'field-effect',
...
export const PAGES_CONTENT = {
    ...
    ripple: {
        ...
        text: "When you tune your own instrument—your body and mind—you don't just heal yourself. You become a broadcasting station of peace. This passive benefit regulates the nervous systems of those around you, creating a subtle harmonization of the collective field."
    },
    history: {
        title: "Lineages",
